...
def add_indicators(df: pd.DataFrame) -> pd.DataFrame:
    """Add MA_FAST, MA_SLOW and ATR columns to OHLCV dataframe."""
    ...
    df.loc[~prev_above & curr_above, "cross"] = 1   # golden cross → BUY
    df.loc[prev_above & ~curr_above, "cross"] = -1  # death  cross → SELL
